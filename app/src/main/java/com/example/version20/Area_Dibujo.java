...
public class Area_Dibujo extends View {  //Path que utilizaré para ir pintando las lineas
    ...
    public Area_Dibujo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setupDrawing();
    }
